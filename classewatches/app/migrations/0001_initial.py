# Generated by Django 4.2.1 on 2023-05-23 21:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('billing', models.FloatField(default=0.0, verbose_name='Frete')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='app.cart', verbose_name='Carrinho')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('order', models.ManyToManyField(editable=False, to='app.order', verbose_name='Pedido')),
            ],
        ),
    ]
